...
const sendVerificationEmail = async (toEmail, userFullName, verificationLink) => {
  try {
    await transporter.sendMail({
      from: `"Travelora" <${process.env.GMAIL_USER}>`,
      to: toEmail,
        ...
        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 40px;">
          <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="background-color: #1e90ff; padding: 20px; color: white; text-align: center;">
              <h2 style="margin: 0;">Welcome to Travelora!</h2>
            </div>
            <div style="padding: 30px; color: #333;">
              <p style="font-size: 16px;">Hi ${userFullName},</p>
              <p style="font-size: 16px;">
                Thanks for signing up to <strong>Travelora</strong>. Please verify your email address by clicking the button below:
              </p>
            ...
            <div style="background-color: #f4f4f4; padding: 20px; text-align: center; font-size: 12px; color: #999;">
              &copy; ${new Date().getFullYear()} Travelora. All rights reserved.
            </div>
          </div>
        </div>`,
    });
...
const sendUnlockAccountEmail = async (toEmail, userFullName, unlockAccountLink) => {
  try {
    ...
    await transporter.sendMail({
      from: `"Travelora" <${process.env.GMAIL_USER}>`,
      to: toEmail,
      subject: "Account Locked - Unlock Your Travelora Account",
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 40px;">
          <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 30px; color: #333;">
              <p style="font-size: 16px;">Hi ${userFullName},</p>
              <p style="font-size: 16px;">
                Your <strong>Travelora</strong> account was temporarily locked due to 3 incorrect login attempts in a row.
              </p>
              <p style="font-size: 16px;">
...
const sendForgotPasswordEmail = async (toEmail, resetPasswordLink) => {
  try {
    await transporter.sendMail({
      from: `"Travelora" <${process.env.GMAIL_USER}>`,
      to: toEmail,
      subject: "Reset Your Travelora Account Password",
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 40px;">
          <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="background-color: #1e90ff; padding: 20px; color: white; text-align: center;">
            ...
            <div style="padding: 30px; color: #333;">
              ...
              <p style="font-size: 16px;">
                We received a request to reset the password for your <strong>Travelora</strong> account.
              </p>
              <p style="font-size: 16px;">
