    ...
    return (
        ...
        >
            ...
            <div className="hidden md:flex items-center gap-3">
                ...
                {/* ✅ Cart link düzəldildi */}
                <Link
                    to="/addToCart"
                    className="relative rounded-full hover:bg-gray-200 transition p-2"
                >
            ...
            >
                ...
                <div className="flex flex-col gap-2 border-t border-gray-200 px-4 py-3">
                    ...
                    <div className="flex items-center justify-center gap-4 py-2">
                        ...
                        {/* ✅ Cart düz mobil menyuda da işləyir */}
                        <Link
                            to="/cart"
                            className="relative p-2 rounded-full border border-slate-300 hover:bg-gray-100 transition"
                        >
